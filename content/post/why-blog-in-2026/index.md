...
On tech topics, I expect to write about what I'm researching and what I'm learning. This part can also serve as a [/now](https://nownownow.com/about) page for me, even though I'm unsure if I'll update it (no explicit commitment, remember?).
...
Finally, regarding my writing/blogging style, I like to use [links](https://en.wikipedia.org/wiki/Hyperlink) wherever possible, since they are the real backbone of the web.

I care about openness and information sharing, so expect to find lots of links to [Wikipedia](https://en.wikipedia.org/wiki/Main_Page).
